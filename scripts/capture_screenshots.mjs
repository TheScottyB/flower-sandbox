...
const SCREENSHOT_SCENES = [
  ...
  { key: 'about', suffix: '_about', desc: 'About / Information screen (tap ABOUT tab at bottom)' },
  { key: 'subscription', suffix: '_subscription', desc: 'Premium Subscription screen (tap SUBSCRIPTION tab at bottom)' }
];
