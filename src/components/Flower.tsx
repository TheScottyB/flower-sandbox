...
export const Flower = React.memo(
  ({
    ...
    useEffect(() => {
      ...
      // Add subtle perpetual swaying movement
      swayRotation, // Start with growing animation
      scale, // Add a bit of random rotation to each flower
      rotation,
    ]);
    ...
    const flowerStyle = useAnimatedStyle(() => {
      return {
        transform: [{ rotate: `${swayRotation.value}rad` }],
      };
    });
        ...
        <Animated.View style={containerStyle}>
          <Animated.View style={flowerStyle}>
            <Svg width={size} height={size} viewBox="0 0 100 100">
              ...
              {/* Center */}
              <Path d={flowerData.center} fill={flowerData.centerColor} />
            </Svg>
          </Animated.View>
        </Animated.View>
      </TouchableOpacity>
